...
class MultiplechoiceActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when (getcode) {
            ...
            204 -> {Toast.makeText(this,"해당이름의 부스없음",Toast.LENGTH_SHORT);finish()}
            205 -> {Toast.makeText(this,"이미 해당팀에서 점령된 부스임",Toast.LENGTH_SHORT);finish()}
            401 -> {Toast.makeText(this,"request header 에 access token 없음",Toast.LENGTH_SHORT);finish()}
            406 -> {Toast.makeText(this,"권한없음",Toast.LENGTH_SHORT);finish()}
            408 -> {Toast.makeText(this,"딜레이시간",Toast.LENGTH_SHORT);finish()}
            412 -> {Toast.makeText(this,"게임종료",Toast.LENGTH_SHORT);finish()}
        }
